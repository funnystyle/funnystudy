...
import io.funnystyle.restbest.common.TestDescription;
...
public class EventControllerTests {
    ...
    @Test
    @TestDescription("정상적으로 실행되는지 테스트")
    ...
    @Test
    @TestDescription("입력 밧이 잘못된 경우에 에러가 발생하는 이벤트")
